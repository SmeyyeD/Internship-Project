...
function NavBar() {
    return (
        <div class="flex flex-col items-center justify-center h-screen text-left px-4 sm:px-8 pt-[300px]">
            <h1 class="font-bold text-xl sm:text-2xl md:text-3xl text-left w-full max-w-6xl">
                Who we are
            </h1>
            <p class="mt-6 sm:mt-8 text-left sm:max-w-5xl md:max-w-6xl mx-auto text-2xl tracking-normal">
