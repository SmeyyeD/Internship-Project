...
function Header() {
    return (
        ...
        <div class="relative w-full h-[700px] flex justify-center items-center overflow-hidden">
            <img src="images/BG.png" alt="Background Image" class="absolute top-0 left-0 w-full h-[1000px] object-cover" />
            <img src="images/Bg-Shape.png" alt="Background Shape" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  h-[700px] object-cover" />
